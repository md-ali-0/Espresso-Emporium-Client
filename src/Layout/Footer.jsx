                ...
                <div className="flex flex-col md:flex-row justify-between gap-2 md:gap-5">
                        ...
                        <div className="flex justify-center md:flex-col gap-5">
                            <div className="w-1/2 md:w-auto">
                                ...
                                <p className="text-xl py-2">
                                    Always ready to be your friend. Come &
                                    Contact with us to share your memorable
                    ...
                    <div className="w-full md:w-1/2">
                        ...
                        <textarea
                            ...
                            rows="5"
                        />
                        <button className="border-2 rounded-3xl border-dark_01 text-dark_01 text-xl px-2 py-1 my-2">
                            Send Message
                        </button>
                    </div>
                </div>
